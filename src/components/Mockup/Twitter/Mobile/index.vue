<template>
  <article class="smc-mockup smc-mockup-twitter smc-mockup-twitter--mobile">
    ...
    <div class="smc-twitter-footer">
        <span class="smc-btn smc-twitter-comments--date">8/26/19</span>
    </div>
    <div class="smc-twitter-comments">
        <span class="smc-btn smc-twitter-comments--reply"></span>
        <span class="smc-btn smc-twitter-comments--retweet"></span>
        <span class="smc-btn smc-twitter-comments--favourite"></span>
