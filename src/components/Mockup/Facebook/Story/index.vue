<template>
  <article class="smc-mockup smc-mockup-facebook smc-mockup-facebook-story">
    <img class="smc-instagram-story-media" :src="assets[0]" alt="" v-if="assetType === 'image'">
    <video preload="metadata" loop class="smc-instagram-story-media-video" v-if="assetType === 'video'" @click="onSmcPlayVideoClick">
