<template>
  <article class="smc-mockup smc-mockup-linkedin smc-mockup-linkedin--mobile smc-mockup-linkedin--carousel-mobile">
    <div class="smc-mockup-top">
        ...
        <span class="smc-btn smc-linkedin-more-options smc-artdeco-icon">
            <i></i>
        </span>
    </div>
    ...
    <div class="smc-mockup-media mobile">
      <Carousel publisher="linkedin" mode="mobile" :assets="assets" :assetType="assetType" />
    </div>
